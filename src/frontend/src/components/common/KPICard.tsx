...
export const KPICard: React.FC<KPICardProps> = ({
  ...
  return (
    <div className="bg-[#111827]/90 border border-[#1f2d44] rounded-lg p-4 shadow-lg backdrop-blur-sm relative overflow-hidden transition-all duration-200 hover:border-slate-600 hover:bg-[#151f33]">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <div className="mt-1 flex items-baseline gap-2">
            ...
            {badge && (
              <span className={`text-[10px] uppercase tracking-wider font-mono px-1.5 py-0.5 rounded border ${badgeStyles}`}>
                {badge.text}
              </span>
            )}
          </div>
